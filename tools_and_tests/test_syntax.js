...
const questionsL1 = global.window.questionsL1;
...
const tests = [
    { name: "LỚP 1", generator: questionsL1, isL1: true, types: [
        "l1-cac-so-0-5-d1", "l1-cac-so-6-10-d1", "l1-nhieu-it-bang-d1", "l1-so-sanh-so-d1", "l1-so-sanh-so-d2",
        "l1-may-va-may-d1", "l1-luyen-tap-c1-d1", "l1-luyen-tap-c1-d2", "l1-hinh-phang-d1", "l1-xep-hinh-d1",
        "l1-luyen-tap-c2-d1", "l1-cong-pham-vi-10-d1", "l1-cong-pham-vi-10-d2", "l1-tru-pham-vi-10-d1", "l1-tru-pham-vi-10-d2",
        "l1-bang-cong-tru-10-d2", "l1-luyen-tap-c3-d1", "l1-hinh-khoi-d1", "l1-vi-tri-khong-gian-d1", "l1-luyen-tap-c4-d1",
        "l1-so-hai-chu-so-d1", "l1-so-sanh-so-100-d1", "l1-so-sanh-so-100-d2", "l1-bang-so-100-d1", "l1-dai-ngan-d1",
        "l1-don-vi-do-d1", "l1-thuc-hanh-do-d1", "l1-luyen-tap-c7-d1", "l1-cong-2cs-1cs-d1", "l1-cong-2cs-2cs-d1",
        "l1-cong-2cs-2cs-d2", "l1-tru-2cs-1cs-d1", "l1-tru-2cs-2cs-d1", "l1-tru-2cs-2cs-d2", "l1-luyen-tap-c8-d1",
        "l1-luyen-tap-c8-d2", "l1-xem-gio-d1", "l1-ngay-trong-tuan-d1", "l1-thuc-hanh-lich-d1", "l1-on-tap-cuoi-nam-10-d1",
        "l1-on-tap-cuoi-nam-100-d1", "l1-on-tap-cuoi-nam-hinh-d1"
    ]},
    ...
    testSuite.types.forEach(type => {
        ...
        for (let i = 0; i < 20; i++) {
            try {
                ...
                const qText = testSuite.isL6 ? q.question : (q.questionText || q.question);
                const solText = testSuite.isL6 ? q.solution : (q.solutionHtml || q.solution);
                if (!checkLatexBalance(qText) || q.options.some(o => !checkLatexBalance(o)) || !checkLatexBalance(solText)) {
