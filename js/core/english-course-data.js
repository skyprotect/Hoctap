/**
 * english-course-data — Dữ liệu bài học và giáo trình Tiếng Anh Lớp 1, 4, 6 (Canonical Course Data Boundary).
 * Tách biệt hoàn toàn khỏi logic sinh đề và generator trong js/english_data.js.
 * Hỗ trợ UMD (Node.js CommonJS, Web Workers, Browser Global).
 *
 * Public Contract:
 * - ENGLISH_COURSE_DATA: Record<string, { levelLabel: string, topics: Array<Object> }>
 */
(function (root, factory) {
    ...
    root.EnglishCourseData = api;
    root.ENGLISH_COURSE_DATA = api.ENGLISH_COURSE_DATA;
    if (typeof window !== 'undefined') {
        window.EnglishCourseData = api;
        window.ENGLISH_COURSE_DATA = api.ENGLISH_COURSE_DATA;
    }
    if (typeof globalThis !== 'undefined') {
        globalThis.EnglishCourseData = api;
        globalThis.ENGLISH_COURSE_DATA = api.ENGLISH_COURSE_DATA;
    }
    if (typeof self !== 'undefined') {
        self.EnglishCourseData = api;
        self.ENGLISH_COURSE_DATA = api.ENGLISH_COURSE_DATA;
    }
