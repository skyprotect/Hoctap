...
- Name: tests\kiosk.spec.js >> E2E Integration Test for Student App and Offline Sync Fallback >> Offline Fallback: Tự lưu LocalStorage khi mất kết nối mạng và tự đồng bộ khi online lại
- Location: tests\kiosk.spec.js:25:3
