...
const JUSTIFIED_EXCEPTIONS = [
  ...
  { pattern: /^student\.html$/i, maxLines: 4000, reason: 'Student Single-Page Application root markup & inline SVG assets' },
  ...
  { pattern: /^js[\\/]lessons\.js$/i, maxLines: 5000, reason: 'Math lesson definitions dataset' },
  { pattern: /^js[\\/]parent\.js$/i, maxLines: 3500, reason: 'Parent administration controller and dashboard subsystem' },
  { pattern: /^js[\\/]questions-7991\.js$/i, maxLines: 1500, reason: 'Math 7991 question bank dataset' },
  { pattern: /^js[\\/]questions-advanced\.js$/i, maxLines: 700, reason: 'Math advanced challenge question bank dataset' },
  { pattern: /^js[\\/]questions-v1\.js$/i, maxLines: 1300, reason: 'Math v1 legacy question bank dataset' },
  { pattern: /^js[\\/]questions-v3\.js$/i, maxLines: 10000, reason: 'Math v3 primary interactive question engine and runner' },
  { pattern: /^js[\\/]questions-v4\.js$/i, maxLines: 1300, reason: 'Math v4 secondary question bank dataset' },
  { pattern: /^server[\\/]services[\\/]student\.service\.ts$/i, maxLines: 600, reason: 'Student backend business logic and OCC coordinator' },
  { pattern: /^tests[\\/]client_occ_reconciliation\.test\.js$/i, maxLines: 800, reason: 'Client OCC reconciliation characterization test suite' },
  { pattern: /^tests[\\/]core[\\/]audio-service\.test\.js$/i, maxLines: 600, reason: 'Audio subsystem unit tests' },
  { pattern: /^tests[\\/]core[\\/]emoji-utils\.test\.js$/i, maxLines: 500, reason: 'Emoji utils unit tests' },
  { pattern: /^tests[\\/]core[\\/]question-generator-worker\.test\.js$/i, maxLines: 600, reason: 'Worker generation unit tests' },
  { pattern: /^tests[\\/]core[\\/]string-utils\.test\.js$/i, maxLines: 500, reason: 'String utils unit tests' },
  { pattern: /^tests[\\/]core[\\/]student-data-integrity\.characterization\.test\.js$/i, maxLines: 800, reason: 'Student data integrity test suite' },
  { pattern: /^tests[\\/]math-practice-lifecycle\.test\.js$/i, maxLines: 1000, reason: 'Math practice lifecycle test suite' },
